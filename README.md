...
| [**Kit**](https://github.com/Zwin-ux/kit) | This local TUI workbench runs bounded coding jobs through Codex, Claude Code, or Grok Build. It also attaches safe CLI services. Its proof runs Trenchwire with offline market data. It has 110 unit tests and CLI smoke checks. |
